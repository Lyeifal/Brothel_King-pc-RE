...
label init_items():
    ...
    python:
        ...
        all_items = [
                    ...
                    Item(name = 'Holy sword', target = 'MC', type = IT_Weapon, pic = 'Holy sword.webp', rank = 4, rarity = 4, price = 40000, effects = (Effect('change', 'strength', 6), Effect('change', 'spirit', 3), ), description =  "This sword hums with power. The light reflects so brightly on its blade it could blind the angels themselves."),
                    Item(name = 'Ebony sword', target = 'MC', type = IT_Weapon, pic = 'Ebony sword.webp', rank = 4, rarity = 5, price = 100000, effects = (Effect('change', 'strength', 8), Effect('change', 'charisma', 4), Effect('change', 'spirit', -2), ), description =  "This blade is made of a mysterious alloy that shifts in and out of existence. It is said every hit with this blade drains a part of your soul; but it's more like a slight tug."),
