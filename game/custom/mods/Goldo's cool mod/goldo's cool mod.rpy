...
label my_mod_init():
    ...
    menu:
        ...
        "Blondes":
            $ mymod.sec_pic = "resources/events/thief (5).webp"
            $ end_picture = "resources/events/thief captured (1).webp"

        "Redheads":
            $ mymod.sec_pic = "resources/events/thief (6).webp"
            $ end_picture = "resources/events/thief captured (3).webp"

        "Blue-haired":
            $ mymod.sec_pic = "resources/events/thief (3).webp"
            $ end_picture = "resources/events/thief captured (4).webp"
