    ...
    python:
        ...
        spellbook = {
                    "Warrior" : [
                            ...
                            Spell('The Defender', 'defender.webp', type="passive", level=3, effects=[Effect("special", "defender", 1)], description="You will have to get past me."),
                            ...
                            Spell('The Ultimate Defender', 'defender2.webp', type="passive", level=25, effects=[Effect("special", "defender", 2)], description="It's like you can be everywhere at once."),
                            ],
                    "Trader" : [
                            ...
                            Spell('The Ultimate Seducer', 'love2.webp', type="passive", level=25, effects=[Effect("change", "job customer capacity", 2, scope="brothel"), Effect("change", "whore customer capacity", 1, scope="brothel")], description="Babe, you're so valuable to me, so valuable that I need you out here, making it count. Go girl!"),
                            ],
                    "Wizard" : [
                            ...
                            Spell('Mindtrick', 'mindtrick.webp', type="trick", level=24, cost=10, duration="turn", effects=[Effect("boost", "job customer budget", 0.2, scope="brothel"), Effect("boost", "whore customer budget", 0.2, scope="brothel")], description="Learnt that trick from an old bum called Zobiwan. He was good at escorting druids, though."),
                            Spell('Mass hysteria', 'mass hysteria.webp', type="passive", level=25, effects=[Effect("special", "hypnosis spillover", 1, scope="brothel")], description="There's stuff in the water, I'm telling ya."),
                            ],
                    }
...
label init_moons():
    python:
        moons = {
                 ...
                 3 : Moon("blue", effects=[Effect("change", "customers", 2, scope="brothel", scales_with="district"), Effect("change", "mood modifier", -1, scope="brothel")], description="On a blue moon, people feel depressed and lonely. Many look for company in the town's brothels.", sound = s_crowd_cheer),
