...
## Dialogue functions ##
    ...
    def add_dialogue(topic, keys="generic", lines="", multiple=False, love=0, fear=0, mood=0, min_cap=None, max_cap=None, changes=[], sound=None, unlock=None):
        ...
        # if multiple is set to True, all lines in lines will be pronounced in succession (advanced dialogue)
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play a little interested", ("holy"), ("In theory Arios forbids it. But I am curious. So... *wink*", "I might be interested. *wink* So let's make it count.", "How could you know I was just wondering how that would feel like? Are you blessed by Arios?"), love=4)
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat well_being -2", ("prude", "very modest"), ["g: Not at all!! I've been feeling sick day and night.", "g: I fear that I will never be able to erase the horrors that I have seen here from my mind."], multiple=True, unlock="MI")
