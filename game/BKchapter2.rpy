...
label kurohime_conversation_menu():
    ...
    menu:
        "I will gladly do it":            $ norollback()
            $ MC.good += 1
...
label c2_homura_okiya1():
    ...
    menu:
        "Tell her about the Princess's request":            $ norollback()
    ...
    if special:
        ...
        if special == "fast":
            ...
            if game.chapter == 2:
                ...
                $ game.set_task("The Water Kunoichi: Gather hints from your contacts", "story2", blocking=False)
...
label intercept_narika():
    ...
    if ninja.flags["hunt stage"] == 1:
        ...
        menu:
            "Defuse the situation":                $ norollback()
        ...
        menu:
            "What are you doing in Zan?":                $ norollback()
        ...
        $ game.set_task("The Void Kunoichi: Meet at the brothel with Suzume tonight.", "story3")
...
label intercept_mizuki():
    ...
    if ninja.flags["hunt stage"] == 1:
        ...
        menu:
            "I'll keep it in mind":                $ norollback()
        ...
        menu:
            "We could kill them for you":                $ norollback()
                $ MC.evil += 1
...
label intercept_haruka():
    ...
    if NPC_haruka.flags["hunt stage"] == 1:
        ...
        menu:
            "I am not going to harm you":                $ norollback()
