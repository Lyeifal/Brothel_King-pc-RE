init python:
    ...
    def init_powers(): # Initiates all objects and values for evil powers
        ...
        evpower_list =  [
                            ...
                            EvilPower(name=__('Abduction'), type='Bronze', power='kidnap', target='city girl', short_description='Attempts to kidnap a free girl, may get hurt in the process', description='She__('will go to the city at night and attempt capturing a free girl. Her chances improve with her defense level.'), mojo_cost=[('yellow', 3)], sanity_cost=2),
                            ...
                            EvilPower(name=__('Even out'), type='Bronze', power='normalize skills BBCR', target='conduit', short_description="Averages out some of her skills (Beauty, Body, Charm & Refinement)", description="Bea__("ty, Body, Charm and Refinement skills converge on their average value"), mojo_cost=[('green', 3)], sanity_cost=2),
                            EvilPower(name=__('Even out'), type='Bronze', power='normalize skills LOCS', target='conduit', short_description="Averages out some of her skills (Libido, Obedience, Constitution, Sensitivity)", description="Lib__("do, Obedience, Constitution and Sensitivity converge on their average value"), mojo_cost=[('blue', 3)], sanity_cost=2),
                            EvilPower(name=__('Shuffle'), type='Bronze', power='shuffle skills BBCR', target='conduit', short_description="Randomly shuffles the value of some of her skills (Beauty, Body, Charm & Refinement)", description="Bea__("ty, Body, Charm and Refinement skill values are shuffled randomly"), mojo_cost=[('yellow', 3)], sanity_cost=2),
                            EvilPower(name=__('Shuffle'), type='Bronze', power='shuffle skills LOCS', target='conduit', short_description="Randomly shuffles the value of some of her skills (Libido, Obedience, Constitution, Sensitivity)", description="Lib__("do, Obedience, Constitution and Sensitivity skill values are shuffled randomly"), mojo_cost=[('red', 3)], sanity_cost=2),
                            ...
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech service sex', target='other girl', short_description="Leeches some of her skills (Service & Sex) to another girl", description='Lee__('hes some of her service and sex skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('green', 1), ('blue', 1)], sanity_cost=2),
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech anal fetish', target='other girl', short_description="Leeches some of her skills (Anal & Fetish) to another girl", description='Lee__('hes some of her anal and fetish skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('red', 1), ('yellow', 1)], sanity_cost=2),
                            ...
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech beauty body', target='other girl', short_description="Leeches some of her skills (Beauty & Body) to another girl", description='Lee__('hes some of her beauty and body skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('blue', 1), ('red', 1)], sanity_cost=1),
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech charm refinement', target='other girl', short_description="Leeches some of her skills (Charm & Refinement) to another girl", description='Lee__('hes some of her charm and refinement skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('green', 1), ('yellow', 1)], sanity_cost=1),
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech sensitivity constitution', target='other girl', short_description="Leeches some of her skills (Sensitivity & Constitution) to another girl", description='Lee__('hes some of her sensitivity and constitution skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('green', 1), ('red', 1)], sanity_cost=1),
                            EvilPower(name=__('Leech skills'), type='Regular', power='leech libido obedience', target='other girl', short_description="Leeches some of her skills (Libido & Obedience) to another girl", description='Lee__('hes some of her libido and obedience skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('blue', 1), ('yellow', 1)], sanity_cost=1),
        ...
        evpower_super_list = [
                                ...
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech service sex', target='other girl', short_description="Leeches some of her skills (Service & Sex) to another girl (larger effect)", description='Lee__('hes more of her service and sex skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('green', 2), ('blue', 2)], sanity_cost=3),
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech anal fetish', target='other girl', short_description="Leeches some of her skills (Anal & Fetish) to another girl (larger effect)", description='Lee__('hes more of her anal and fetish skills and transfers them to a girl of equal or lower rank'), mojo_cost=[("red", 2), ('yellow', 2)], sanity_cost=3),
                                ...
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech beauty body', target='other girl', short_description="Leeches some of her skills (Beauty & Body) to another girl (larger effect)", description='Lee__('hes more of her beauty and body skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('blue', 2), ('red', 2)], sanity_cost=1),
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech charm refinement', target='other girl', short_description="Leeches some of her skills (Charm & Refinement) to another girl (larger effect)", description='Lee__('hes more of her charm and refinement skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('green', 2), ('yellow', 2)], sanity_cost=1),
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech sensitivity constitution', target='other girl', short_description="Leeches some of her skills (Sensitivity & Constitution) to another girl", description='Lee__('hes more of her sensitivity and constitution skills and transfers them to a girl of equal or lower rank (larger effect)'), mojo_cost=[('green', 2), ('red', 2)], sanity_cost=1),
                                EvilSuperPower(name=__('Leech skills'), type='Regular', power='leech libido obedience', target='other girl', short_description="Leeches some of her skills (Libido & Obedience) to another girl (larger effect)", description='Lee__('hes more of her libido and obedience skills and transfers them to a girl of equal or lower rank'), mojo_cost=[('blue', 2), ('yellow', 2)], sanity_cost=1),
