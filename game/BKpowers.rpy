init python:
    ...
    def init_powers(): # Initiates all objects and values for evil powers
        ...
        evpower_super_list = [
                                ...
                                EvilSuperPower(name='Leech skills', type='Regular', power='leech anal fetish', target='other girl', short_description="Leeches some of her skills (Anal & Fetish) to another girl (larger effect)", description='Leeches more of her anal and fetish skills and transfers them to a girl of equal or lower rank', mojo_cost=[("red", 2), ('yellow', 2)], sanity_cost=3),
