...
# If every picture is 'gallery' set to False, it must be put in the 'unused' subdictionary.
    ...
    game_image_dict["Backgrounds"] = {
                                        ...
                                        "outside" : [
                                                ...
                                                declare('bg execution_plaza', 'backgrounds/execution plaza.webp', 's'),
                                                ...
                                                declare('bg cave entrance', 'backgrounds/cave entrance.webp', 's', wide=True),
                                                declare('bg fire outside', 'backgrounds/fire outside.webp', 's', wide=True),
                                                ],
                                        ...
                                        "inside" : [
                                                ...
                                                declare('bg mansion inside', 'backgrounds/mansion inside.webp', 's', wide=True),
                                                declare('bg mansion inside2', 'backgrounds/mansion inside2.webp', 's', wide=True),
                                                declare('bg mansion fire', 'backgrounds/fire inside.webp', 's', wide=True),
                                        ...
                                        "locations" : list_imgfiles(path="districts/locations/") + [
                                                    ...
                                                    declare('bg gallows', 'districts/locations/gallows.webp', 's', gallery=False),
                                                    declare('bg market', 'districts/locations/market.webp', 's', gallery=False),
                                                    declare('bg exotic_emporium', 'districts/locations/Exotic emporium.webp', 's', gallery=False),
                                                    ...
                                                    declare('bg pilgrim_road', 'districts/locations/Pilgrim road.webp', 's', gallery=False, wide=True),
    ...
    game_image_dict["Story"] = {
                                ...
                                "goldie sex2" : declare_multiple("bg goldie_titjob%s", "NPC/Goldie/titjob%s.webp", "p", start=1, finish=2), #! Update to 1-4 after repeatable event
                                ...
                                "kenshin soft" : [declare('bg kenshin secret', 'NPC/kenshin/secret meeting.webp', 'p'), declare('kenshin showdown', 'NPC/kenshin/showdown.webp', 'p')],
                                ...
                                "homura rest" : declare_multiple('bg homura_rest%s', 'NPC/homura/rest (%s).webp', 'p', start=1, finish=4),

                                "homura ninja" : [declare('homura showdown', 'NPC/homura/showdown.webp', 'p'), declare('bg homura fire', 'NPC/homura/fire.webp', 'p')],

                                "homura tryst" : declare_multiple('bg homura_tryst%s', 'NPC/homura/tryst (%s).webp', 'p', start=1, finish=4),

                                "homura capture" : declare_multiple('bg homura_capture%s', 'NPC/homura/capture (%s).webp', 'p', start=1, finish=5),

                                "homura farm" : declare_multiple('bg homura_farm%s', 'NPC/homura/farm (%s).webp', 'p', start=1, finish=6),

                                "homura group" : declare_multiple('bg homura_group%s', 'NPC/homura/group (%s).webp', 'p', start=1, finish=4),

                                "homura grass" : declare_multiple('bg homura_grass%s', 'NPC/homura/grass (%s).webp', 'p', start=1, finish=4),

                                "narika soft" : [declare('bg narika intro', 'NPC/kunoichi/narika/intro.webp', 'p'),
                                                declare('narika showdown', 'NPC/kunoichi/narika/showdown.webp', 'p'),
                                                ],
                                ...
                                "mizuki soft" : [
                                                ...
                                                declare('bg mizuki defeat', 'NPC/kunoichi/mizuki/defeat.webp', 'p'),
                                                declare('mizuki showdown', 'NPC/kunoichi/mizuki/showdown.webp', 'p'),
                                ...
                                "mizuki goodbye" : declare_multiple("bg mizuki sex%s", "NPC/kunoichi/mizuki/sex (%s).webp", "p", start=1, finish=6) + declare_multiple("bg mizuki goodbye%s", "NPC/kunoichi/mizuki/disappear (%s).webp", "p", start=1, finish=3),

                                "mizuki brothel" : declare_multiple("bg mizuki brothel service%s", "NPC/kunoichi/mizuki/brothel service (%s).webp", "p", start=1, finish=3) +  declare_multiple("bg mizuki brothel sex%s", "NPC/kunoichi/mizuki/brothel sex (%s).webp", "p", start=1, finish=5) +
                                declare_multiple("bg mizuki brothel anal%s", "NPC/kunoichi/mizuki/brothel anal (%s).webp", "p", start=1, finish=5) +
                                declare_multiple("bg mizuki brothel fetish%s", "NPC/kunoichi/mizuki/brothel fetish (%s).webp", "p", start=1, finish=4) +
                                declare_multiple("bg mizuki brothel final%s", "NPC/kunoichi/mizuki/brothel final (%s).webp", "p", start=1, finish=3),

                                "mizuki capture" : declare_multiple("bg mizuki capture%s", "NPC/kunoichi/mizuki/capture (%s).webp", "p", start=1, finish=3),

                                "haruka soft" : [declare('bg haruka intro', 'NPC/kunoichi/haruka/intro.webp', 'p'), declare('haruka showdown', 'NPC/kunoichi/haruka/showdown.webp', 'p')] +
                                ...
                                "carpenter sex" : declare_multiple("bg iulia_sex%s", "NPC/carpenter/sex%s.webp", "p", start=1, finish=6),
    ...
    game_image_dict["Characters"] = OrderedDict([
                                ...
                                ("jobgirl", [
                                        ...
                                        declare('jobgirl normal', 'NPC/Jobgirl/body.webp', "tall", gallery=False),
                                        declare('jobgirl magic', 'NPC/Jobgirl/body magic.webp', "tall"),
                                        declare('jobgirl magic normal', 'NPC/Jobgirl/body magic.webp', "tall", gallery=False),
            ...
            #                            declare('goldie_swimsuit', 'NPC/Goldie/body swimsuit.webp'),
                                ...
                                ("carpenter", [
                                        ...
                                        declare('carpenter attack2', 'NPC/carpenter/attack2.webp', "med"),
                                        declare('carpenter lingerie', 'NPC/carpenter/body lingerie.webp', "tall"),
                                ...
                                ("kenshin", [
                                        ...
                                        declare('kenshin normal', 'NPC/kenshin/body.webp', "tall", gallery=False),
                                        declare('kenshin blush', 'NPC/kenshin/body.webp', "tall", gallery=False),
                                        declare('kenshin annoyed', 'NPC/kenshin/body.webp', "tall", gallery=False),
                                ...
                                ("homura", [
                                        ...
                                        declare('homura normal', 'NPC/homura/body.webp', "p", gallery=False),
                                        ...
                                        declare('homura ninja', 'NPC/homura/body ninja.webp', "p"),
                                        declare('homura attack', 'NPC/homura/body attack.webp', "p"),
                                        ...
                                        declare('side homura ninja', 'NPC/homura/portrait ninja.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False),
                                        declare('side homura sepia', 'NPC/homura/portrait ninja.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False, sepia=True),
                                        declare('side homura attack', 'NPC/homura/portrait ninja.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False, sepia=True),
                                        ]),
                                ...
                                ("kunoichi", [
                                        ...
                                        declare('mizuki_rest', 'NPC/kunoichi/mizuki/body rest.webp', "p"),
                                        declare('mizuki normal', 'NPC/kunoichi/mizuki/body.webp', "p", gallery=False),
                                        declare('mizuki naked', 'NPC/kunoichi/mizuki/body naked.webp', "p"),
                                        ...
                                        declare('kunoichi', 'NPC/kunoichi/kunoichi.webp', "tall", gallery=False),
                                ...
                                ("receptionist", [
                                        ...
                                        declare('receptionist normal', 'NPC/receptionist/body.webp', "tall", gallery=False),
                                ...
                                ("shizuka", [
                                        ...
                                        # declare('shizuka normal', 'NPC/shizuka/body.webp', "tall", gallery=False),
                            ...
                            # Extras
                                ...
                                ('hermit', [declare('hermit', 'NPC/Misc/hermit.webp', "tall"),]),
                                ('clerk', [declare('clerk', 'NPC/Misc/clerk.webp', "med"),]),
                                ...
                                ('lost soldier', [declare('lost_soldier', 'NPC/Misc/lost soldier.webp', "med"),]),
                                ...
                                ("mask", [declare('mask', 'NPC/The Mask/body.webp', "tall"),
                                        declare('mask blind', 'NPC/The Mask/body blind.webp', "tall"),
                                        declare('mask attack', 'NPC/The Mask/attack.webp', "tall"),
                                        declare('mask blind attack', 'NPC/The Mask/blind attack.webp', "tall"),
                                        declare('side mask unknown', 'NPC/Misc/killer.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False),
                                        declare('side mask', 'NPC/The Mask/portrait.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False),
                                        declare('side mask blind', 'NPC/The Mask/portrait blind.webp', 'p', x=res_portrait_size, y=res_portrait_size, gallery=False),
    ...
    game_image_dict["Misc"] = {
                                ...
                                "mask events" : [declare('bg mask escape', 'NPC/The Mask/escape.webp', 'p')] + [declare('bg mask driver1', 'NPC/The Mask/driver1.webp', "p"), declare('bg mask driver2', 'NPC/The Mask/driver2.webp', "p"),] + [declare('mask showdown', 'NPC/The Mask/showdown.webp', 'p')] + declare_multiple("bg mask_duel%s", "NPC/The Mask/fire duel%s.webp", "p", start=1, finish=2) + declare_multiple("bg mask_duel%s blind", "NPC/The Mask/fire duel blind%s.webp", "p", start=1, finish=2),

                                "mask flashbacks" : declare_multiple("bg c3_flashback%s", "NPC/The Mask/flashback%s.webp", "p", start=0, finish=10) + [declare('bg mask rooftop', 'NPC/Homura/rooftop.webp', 'p'), declare('bg mask duo', 'NPC/Homura/duo.webp', 'p')],

                                "c3 showdown" : [declare('bg showdown all', 'NPC/kunoichi/showdown all.webp', 'p')],

                                "c3 kosmo" : declare_multiple("bg kosmo fall%s", "NPC/Kosmo/rail%s.webp", "p", start=1, finish=2),

                                "succubi" : declare_multiple('bg succubi%s', 'events/succubi (%s).webp', 'p', start=1, finish=6),

                                "oni" : declare_multiple('bg oni%s', 'events/oni (%s).webp', 'p', start=1, finish=3),
                                ...
                                "old_general" : [declare('bg old_general', 'NPC/Misc/old general.webp', 'p', wide=True)],

                                "arios" : [declare('bg arios', 'NPC/Misc/arios.webp', 'p', wide=True), declare('bg arios_evil', 'NPC/Misc/arios evil.webp', 'p'),],
