...
translate chinese_simplified strings:
    ...
    old "By Arios"
    new "以阿里奥斯之名"
    old "By the Lightbringer"
    new "以光明使者之名"
    old "By the Lord of Light"
    new "以光明之主之名"
    old "By Shalia"
    new "以莎莉亚之名"
    old "Goddess"
    new "女神"
    old "By the Night Lady"
    new "以夜之女士之名"
    old "Demons"
    new "恶魔"
    old "Damnation"
    new "诅咒"
    old "Priests be damned"
    new "让祭司们见鬼去吧"
    old "By the Seven Hells"
    new "以七层地狱之名"
    old "Gold: "
    new "金币： "
    old "Prestige "
    new "声望 "
    old "\n{color=[c_red]}You are wounded for %i day%s.{/color}"
    new """
{color=[c_red]}你受伤了，需要疗养 %i 天%s。{/color}"""
    old ", Y%s M%s D%s"
    new "，%s年 %s月 %s日"
