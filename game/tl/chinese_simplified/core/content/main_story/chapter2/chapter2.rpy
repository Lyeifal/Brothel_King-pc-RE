...
translate chinese_simplified sewer_girl_returns_menu_617e6ef6:
    ...
    sewer_woman "抱歉,我真的得走了。在上次被绑架之后,我发誓永远也不会在晚上独自走在泽恩的街道上。"
...
translate chinese_simplified c2_intro_2c601bfe:
    ...
    "工人、商贩和工匠们在这个城市最繁华的街区来来往往。离这里不远就是泽恩最大的贸易市场,还价的声音源源不绝。"
...
translate chinese_simplified c2_intro_107e2cfd:
    ...
    riche "别扫兴嘛,卡特琳....这{i}确实{/i}是泽恩最大的城市!这里的一切都很神奇?拉米亚斯,你觉得呢?"
...
translate chinese_simplified luncheon2_kenshin_menu_d2914ae1:
    ...
    you "等等，你是说光秀团长？但是你的名字是上杉...我以为泽恩的人会继承父亲的姓氏。"
...
translate chinese_simplified luncheon2_kenshin_menu_a5ad6d66:
    ...
    kenshin "那又怎样?上杉是我母亲的名字，我很自豪地用这个名字。我可不想背负逃兵的污点。"
...
translate chinese_simplified luncheon2_kenshin_menu_6c90f301:
    ...
    kenshin "我母亲十分伟大!她独自抚养我长大,并培养我成为现在的骑士。"
...
translate chinese_simplified c2_meet_papa_freak_d0b81e23:
    ...
    papa "是的,他们也是后来被称为泽恩的这座城市的最初定居者..."
...
translate chinese_simplified c2_meet_papa_freak_3f036dab:
    ...
    "弗里克老爹希望你给他找一个{b}美貌、身材、优雅和魅力都至少50分{/b}的女孩,并且愿意和他共度春宵。"
...
translate chinese_simplified visit_papa_07c43704:
    ...
    "从你的青楼里选一个女孩带去(注意:她必须在美貌、身材、优雅和魅力上都达到50或更高,并且愿意卖淫)"
...
translate chinese_simplified c2_intro_f07da722:
    ...
    "不让希尔的抱怨破坏你的心情，你满意地看着贫民窟被你甩在身后，进入了赞繁华街区熙熙攘攘的街道，踏入了 [_district_name]。"

# game/core/content/main_story/chapter2/chapter2.rpy:434
translate chinese_simplified c2_intro_11130502:
    ...
    you "这个时间街上真热闹……各地的旅客都会来 [_district_name] 逛逛。这对生意应该有帮助……"

# game/core/content/main_story/chapter2/chapter2.rpy:4045
translate chinese_simplified c2_homura_city_meet_4481756f:

    # "One morning, as you open your window, you spot a familiar figure that looks out of place in [_district_name]."
    "一天早上，当你打开窗户时，你看到一个熟悉的身影，在 [_district_name] 显得格格不入。"
...
translate chinese_simplified strings:
    old "I want both (Charisma test: [diff_text])"
    new "我全都要（魅力检定：[diff_text]）"
    old "Get started with your new brothel."
    new "开始经营你的新青楼。"
    old "your early weapon training"
    new "你例行的武器训练"
    old "your usual meditation session"
    new "你例行的冥想课程"
    old "the daily farmer's market"
    new "每日农夫市集"
    old "Choose which girl will entertain Gio"
    new "选择接待 Gio 的女孩"
    old "Choose which girl will entertain Gio (first girl)"
    new "选择接待 Gio 的女孩（第一个）"
    old "Choose which girl will entertain Gio (second girl)"
    new "选择接待 Gio 的女孩（第二个）"
    old "gd: I don't think you're any of the girls' type, anyway. Sorry."
    new "gd：反正我觉得你也算不上女孩们的菜。抱歉啦。"
    old "ne: Boohoo. Cry me a river."
    new "ne：呜呜，哭哭啼啼。"
    old "ev: Damn right I'm mean! Now give me this letter before I show you just how bad I am."
    new "ev：对，我就是坏！快把信给我，不然我就让你见识见识我有多坏。"
    old "Princess Kurohime"
    new "黑公主"
    old "Meet Gio at the stables on Saturday."
    new "周六在牲口棚见 Gio。"
    old "Advance through the story to unlock the next chapter."
    new "推进剧情以解锁下一章。"
    old "sh: Yeah, sounds like them all right... Tsk."
    new "sh：嗯，听起来确实像他们……啧。"
    old "ar: Watch it! I won't suffer insults to the name of Arios!"
    new "ar：注意你的言辞！我不会容忍对阿里奥斯之名的侮辱！"
    old "ng: No separation of church and state, uh... How primitive."
    new "ng：政教不分啊，嗯……真原始。"
    old "gd: (Well, that is to be expected, he's got his orders... I'm sure me being here is not making his job any easier.)"
    new "gd：（这也是意料之中，他得听命行事……我待在这儿肯定让他难办。）"
    old "ne: (What a welcome. I wonder if everyone at court is so stuck up?)"
    new "ne：（好个欢迎法。不知王宫里是不是都这么装腔作势？）"
    old "ev: (Fuck that jerk...)"
    new "ev：（去他的混蛋……）"
    old "Wait for someone to pick you up on Monday."
    new "等周一有人来接你。"
    old "gd: Fear not, Your Highness. I will protect you!"
    new "gd：别怕，殿下。我会保护你的！"
    old "ne: All right, all right, Your Highness. I'll help..."
    new "ne：好好好，殿下。我帮忙就是了……"
    old "ev: Worry not, Your Highness, We have a deal, remember?"
    new "ev：别担心，殿下。我们有过交易，记得吗？"
    old "Find out more about the murders of high-ranking officials."
    new "查明高官遇刺案的更多线索。"
    old "Meet Gio at the plaza."
    new "在广场见 Gio。"
    old "Wait for the Kunoichi to show up, and... Murder you?"
    new "等女忍出现，然后……把你杀掉？"
    old "Visit the {b}farm{/b} to return the missing panties."
    new "前往{b}农场{/b}归还不翼而飞的内裤。"
    old "Meet the strange girl again at the {b}farm{/b}."
    new "在{b}农场{/b}再次见那个陌生女孩。"
    old "Visit the upscale hostess club by the {b}Seafront{/b}."
    new "前往{b}海滨{/b}的高档夜总会。"
    old "Wait for Suzume to come back."
    new "等 Suzume 回来。"
    old "mighty warrior"
    new "强大的战士"
    old "grand wizard"
    ...
    old "charming rogue"
    new "魅力四射的浪子"
    old "Get the onsen, and wait for Suzume."
    new "拿下温泉，等 Suzume。"
    old "Go hunt ninjas in the city."
    new "去城里猎捕忍者。"
    old "Meet the Earth Kunoichi."
    new "会见土之忍者。"
    old "Meet the Water Kunoichi."
    new "会见水之忍者。"
    old "Meet the Void Kunoichi."
    new "会见虚之忍者。"
    old "Damn! She's just too fast... She dodges even perfect hits!"
    new "该死！她太快了……连必中的攻击都能躲开！"
    old "The Void Kunoichi: Gather hints from your contacts"
    new "虚之忍者：向你的线人收集线索"
    old "It's a damn storm out here! I can't see a thing!"
    new "外面这暴风雨！我什么都看不见！"
    old "The Water Kunoichi: Gather hints from your contacts"
    new "水之忍者：向你的线人收集线索"
    old "My legs are giving out, and the district is about to crumble..."
    new "我的腿快撑不住了，街区也快塌了……"
    old "The Earth Kunoichi: Gather hints from your contacts"
    new "土之忍者：向你的线人收集线索"
    old "Meet the Void Kunoichi again."
    new "再次会见虚之忍者。"
    old "The Void Kunoichi: Meet at the brothel with Suzume tonight."
    new "虚之忍者：今晚带 Suzume 在青楼见面。"
    old "The Void Kunoichi: Wait for Suzume to report on Narika's arrest."
    new "虚之忍者：等 Suzume 汇报 Narika 被捕的事。"
    old "The Void Kunoichi: Break Narika's will at the brothel."
    new "虚之忍者：在青楼摧垮 Narika 的意志。"
    old "Cast a tracking spell"
    new "施放追踪法术"
    old "Forget it"
    new "算了"
    old "Meet the Void Kunoichi, yet again."
    new "再次，再次会见虚之忍者。"
    old "Meet the Water Kunoichi again."
    new "再次会见水之忍者。"
    old "Swim after it"
    new "游着追它"
    old "Leave it"
    new "别管它了"
    old "Meet the Water Kunoichi, yet again."
    new "再次，再次会见水之忍者。"
    old "The Water Kunoichi: Wait for Suzume to report on Mizuki's arrest."
    new "水之忍者：等 Suzume 汇报 Mizuki 被捕的事。"
    old "The Water Kunoichi: Break Mizuki's will at the brothel."
    new "水之忍者：在青楼摧垮 Mizuki 的意志。"
    old "Meet the Earth Kunoichi again."
    new "再次会见土之忍者。"
    old "Convince her"
    new "说服她"
    old "Meet the Earth Kunoichi, yet again."
    new "再次，再次会见土之忍者。"
    old "The Earth Kunoichi: Wait for Suzume to report on Haruka's arrest."
    new "土之忍者：等 Suzume 汇报 Haruka 被捕的事。"
    old "The Earth Kunoichi: Break Haruka's will at the brothel."
    new "土之忍者：在青楼摧垮 Haruka 的意志。"
    old "wr: I've worked as a hired blade for many such arrogant pricks... They're all the same."
    new "wr：我给许多这种傲慢的混蛋当过雇佣刀手……他们全都一个样。"
    old "wz: Just like the courts of the Westmarch swamp lords... With thankfully less mosquitoes."
    new "wz：就像西境沼泽领主的宫廷一样……值得庆幸的是蚊子少些。"
    old "tr: It's a den of snakes, but knowing these people just might be advantageous for business..."
    new "tr：那是个蛇窝，但认识这些人说不定对生意有好处……"
    old "Bring a whore with {b}at least 50 in Beauty, Body, Refinement and Charm{/b} to Papa Freak, by the %s."
    new "在 %s 之前，带一名{b}美貌、身材、修养和魅力均不低于 50{/b}的妓女去见怪胎老爹。"
    old "Gather %s gold to advance to the next chapter."
    new "筹集 %s 金币以进入下一章。"
