...
translate chinese_simplified strings:
 ...
 by OhWee{/i}"""
    ...
    new "BK [config.version]"
    old "The width value you entered is not a valid number (%s)"
    new "您输入的宽度值不是有效数字 (%s)"
    old "The width value is too high or too low (%s)"
    new "宽度值过高或过低（%s）"
    old "The height value you entered is not a valid number (%s)"
    new "您输入的高度值不是有效数字 (%s)"
    old "The height value is too high or too low (%s)"
    new "高度值过高或过低（%s）"
    old "[config.version]"
    new "[config.version]"
    old "Shift+A"
