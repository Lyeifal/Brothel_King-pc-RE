...
translate chinese_simplified help_brothel_intro_3b2a500f:
    ...
    sill "在这里，你可以调整经营策略，升级青楼，扩建房间和雇佣外包人员。"
...
translate chinese_simplified help_advertising_menu_f889f1f4:
    ...
    sill "一开始你接待的客人以{b}混混{/b}为主,但随着你的青楼等级提高,搬到更高等级的区域,会有更多的客户群体可供选择。"
...
translate chinese_simplified help_advertising_menu_c166846a:
    ...
    sill "当然,吸引更高级的客人所需要的知名度要比混混更多。如果你想要客人的数量尽可能多一些,在{b}经营策略{/b}中屏蔽一些较高等级的客户群体可能会有用。"
...
translate chinese_simplified strings:
    ...
    new "您刚刚经历了一次安全事件。您想了解更多关于安全事件的信息吗？"
    old "Recover a girl from Gizel"
    new "从吉泽尔手中救回一个女孩"
    old "Tell me about farm shows"
    new "请您谈谈农展会的情况。"
    old "Test event"
    new "测试活动"
    old "Cheat modifier"
    ...
    new "作弊修正值是一个浮点数，会影响你的女孩们获得的属性提升、经验值、JP、声望和金币。使用它来调整游戏难度（例如：修正值为 1.5 会使你的女孩们的属性提升 50%；修正值为 0.75 会使属性提升降低 25%）。"
    ...
    new "这将重置“忽略”列表，并将所有女孩角色包恢复为默认设置。是否继续？"
    old "This will create a file named 'ignored_pictures.txt' in your 'game/' directory containing the list of ignored pictures so that you can edit or delete them. Would you like to proceed?"
    new "这将在您的“game/”目录下创建一个名为“ignored_pictures.txt”的文件，其中包含被忽略的图片列表，以便您可以编辑或删除它们。您是否要继续？"
    old "You have just pressed the 'DEL' key. The currently shown picture will be ignored by the game in the future (after the game restarts). You can cancel this action by pressing the 'DEL' key again. Further options can be accessed in the 'Help' menu."
    new "您刚刚按下了“DEL”键。当前显示的图片在游戏重启后将被忽略。您可以再次按下“DEL”键取消此操作。更多选项可在“帮助”菜单中找到。"
    old "Understood"
    new "明白了"
    old "Do not show hint in the future"
    new "未来不要显示提示"
    old "Free girls: %s"
    new "免费女孩：%s"
    old "Couldn't tag %s"
    new "无法标记 %s"
    old "Warning: %s is in %s."
    new "警告：%s 位于 %s 中。"
    old "%s: missing a {b}%s{/b} picture."
    new "%s：缺少 {b}%s{/b} 张图片。"
    old "No girls are missing a %s picture."
    new "没有哪个女孩缺少一张%s照片。"
    old "%s: missing a regular {b}%s{/b} picture."
    new "%s：缺少常规的 {b}%s{/b} 图片。"
    old "%s: missing a {b}naked %s{/b} picture."
    new "%s：缺少一张裸体 %s{/b} 图片。"
    old "No girls are missing a naked %s picture."
    new "没有女孩缺少裸体%s照片。"
    old "%s: missing a {b}%s %s{/b} picture."
    new "%s：缺少 {b}%s %s{/b} 图片。"
    old "No girls are missing a %s %s picture."
    new "没有女孩缺少一张 %s %s 图片。"
    old "Test results - %s"
    new "测试结果 - %s"
    old "Cycle all"
...
translate chinese_simplified strings:
    old "Select picture to remove from set"
    new "选择要从图集中移除的图片"
    old "Event name"
    new "事件名称"
    old "Gold cheat modifier"
    new "金币作弊系数"
    old "XP cheat modifier"
    new "经验作弊系数"
    old "JP cheat modifier"
    new "职业点数作弊系数"
    old "Girl reputation cheat modifier"
    new "女孩声望作弊系数"
    old "Girl stats cheat modifier"
    new "女孩属性作弊系数"
    old "Prestige cheat modifier"
    new "声望作弊系数"
    old "How much?"
    new "多少？"
    old "How many levels?"
    ...
    old "How many ranks"
    new "多少阶"
    old "Choose skill to improve"
    new "选择要提升的技能"
    old "Raise libido/obedience"
    new "提升性欲/服从"
    old "Raise all sexual preferences"
    new "提升所有性偏好"
    old "Item name contains"
    new "物品名称包含"
    old "How many days do you want to skip"
    new "你想跳过多少天"
    old "How much gold will you need?"
    new "你需要多少金币？"
    old "Which rank will they need to reach?"
    new "她们需要达到哪一阶？"
    old "How many girls will need to reach that rank?"
    new "需要多少个女孩达到该阶位？"
    old "How much reputation will you need to get?"
    new "你需要获得多少声望？"
    old "How much prestige will you need to collect?"
    new "你需要收集多少名望？"
    old "TRUE "
    new "TRUE "
    old "FALSE "
    ...
    old "How many?"
    new "多少个？"
    old "Select a girl pack"
    new "选择一个女孩包"
    old "Choose perks to test"
    new "选择要测试的天赋"
    old "Girl nb"
    new "女孩编号"
