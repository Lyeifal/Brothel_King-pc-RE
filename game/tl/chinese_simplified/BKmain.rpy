...
translate chinese_simplified slavemarket_5ea722bf:
    ...
    headhunter "喂，船长！我们正在为新客户提供一次性折扣……*咳咳* {i}折扣{/i}！"
...
translate chinese_simplified slavemarket_loop_9752f4ee:
    ...
    gio "嗯，那个女猎人说的或许有道理。他们卖给像你这样的新手的那些廉价低阶奴隶，确实不太听话。"
...
translate chinese_simplified slavemarket_loop_9546554f:
    ...
    gio "想把这些妓女培养成真正的荡妇可不容易。所以你的妓院可能缺妓女……"
...
translate chinese_simplified slavemarket_loop_f1276e29:
    ...
    gio "除非你接受那个海盗女郎的提议。她那挑逗的举动真是让我们大吃一惊！"
...
translate chinese_simplified farm_loop_ce1b337e:
    ...
    gizel "看来我们别无选择……我要把它送到乡下的农场……让它安享晚年。"
...
translate chinese_simplified farm_loop_84bab26c:
    ...
    you "你的意思是……你要结束它的痛苦，对吧？你要杀了它，是吗？"
...
translate chinese_simplified girls_loop_477ddccc:
    ...
    sill "如果她拒绝做妓女，你就无法启用此选项。{w=1.0}{nw}"
...
translate chinese_simplified assign_job_exit_ccd530c3:
    ...
    slavegirl1 "你已经把这个女孩卖给我们一次了，你不能总是改变主意。我们很忙，你知道的。"
...
translate chinese_simplified shop_f78cbe96:
    ...
    shopgirl "老乔告诉我你很快就要来了。我相信你我一定会成为最好的朋友……😉"
...
translate chinese_simplified shop_b0b83bcb:
    ...
    shopgirl "我们这里出售来自泽罗斯各地的各种普通和稀有物品。欢迎常来逛逛，我们定期有新品到货。"
...
translate chinese_simplified postings_432f0ffb:
    ...
    jobgirl "看到那边的告示板了吗？各种各样的人都在这里留言，寻找零工和小任务……"
...
translate chinese_simplified postings_567c329e:
    ...
    jobgirl "我每天都用它来找工作！上面还有各种课程的广告……我就是这么学会跳舞的！"
...
translate chinese_simplified postings_1775611d:
    ...
    jobgirl "不过你得小心……有些“工作”是由好色的老男人发布的，他们只有一个目的……真恶心！"
...
translate chinese_simplified postings_e2c5a04a:
    ...
    jobgirl "好吧，回头见。你看上去运气不太好。希望你早日找到工作！"
