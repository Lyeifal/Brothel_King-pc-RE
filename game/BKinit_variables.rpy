...
## STORY GIRLS ##
    girl_directories += ["NPC/Kunoichi/narika", "NPC/Kunoichi/haruka", "NPC/Kunoichi/mizuki", "NPC/Homura/"] # girl_directories is initiated in BKsettings. Declare story girl paths here
...
init:
    ...
    image rev_lightning = Transform("minigame/rain/lightning.webp", xzoom = -1.0) # updated transform (Dexell)
