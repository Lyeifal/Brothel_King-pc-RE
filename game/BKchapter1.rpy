...
label c1_meet_kosmo:
    ...
    menu:
        ...
        _("Sill's not for sale"):            $ norollback()
            $ MC.good += 1
            $ NPC_sill.love += 1
...
label c1_sewers:
    ...
    menu:
        ...
        _("Follow the screams"):            $ norollback()
...
#        show roz at center with move
    ...
    show bg execution_plaza at top with dissolve
