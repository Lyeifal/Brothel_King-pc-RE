...
#                         game.mm_log += "\n%s removed (hurt)" % girl
    ...
    python:
        ...
        if not leftover_customers:
            ...
            ev = Event(Picture(pic, "resources/events/" + pic), text = text1 + "girls were available for sex and %s customers left disappointed." % str_int(len(leftover_customers)), type ="UI", changes=night_no_girls, debug_id=1)
...
#### END NIGHT ####
    ...
    ## Pay the rent
        ...
        _gold_recap = "You paid {image=img_gold_24} " + event_color["a little bad"] % '{:,}'.format(round_int(log.upkeep+log.costs)) + " in brothel costs."
    ...
    ## Katchiiing
        ...
        night_late.add("Costs: "  + event_color["bad"] % str_int(-log.upkeep - log.costs), ttip = _gold_text)
