...
label blood1_bj():
    ...
    show bg ka6 at top with dissolve
...
label farm_first_monster():
    ...
    scene black with fade
    show bg farm_monster_den with dissolve
    ...
    show bg gizel_monster1_2 with dissolve
    ...
    show bg gizel_monster1_3 with dissolve
    ...
    show bg gizel_monster1_4 with dissolve
    ...
    show bg gizel_monster1_5 with dissolve
    ...
    show bg gizel_monster1_6 with dissolve
...
#    gizel "Nggh... *gulp* *gulp*"
    ...
    play sound s_orgasm_young
    show bg gizel_monster1_7 with doubleflash
...
label farm_first_machine():
    ...
    you "I forget, you're ten times older than my own grandma..."
...
label farm_first_stallion():
    ...
    "Fancy Brochure" "Congratulations on acquiring your first stallion. It will be a perfect addition to the family, providing endless pleasure to everyone from your daughters to your old grandma."
...
label kosmo_returns(): # Happens 7-9 days after meeting Kosmo
    ...
    kosmo "Everyone knows and respects me, the chairman of {font=resources/fonts/DejaVuSans.ttf}HʘʘKERS™{/font}! I am the center of everyone's attention!" with vpunch
    ...
    kosmo "Look at that, [MC.name]! She's going to be the new star of {font=resources/fonts/DejaVuSans.ttf}HʘʘKERS™{/font}! A virgin, no less! I bought her for a hefty sum..."
...
label visit_bank():
    ...
    if NPC_banker.flags["first loan"]:
        ...
        banker "Ah, [MC.name]. You still have [str_int(MC.loan.amount)] gold to repay on your current loan."
        ...
        menu:
            ...
            "Yes. Repay [str_int(MC.loan.amount)] gold right now and settle your account":
                if MC.repay_in_full():
                    play sound s_gold
    ...
    if NPC_banker.love == 25:
        ...
        menu:
            ...
            "Of course":
                ...
                call banker_special1 from _call_banker_special1_1
...
label treasure_girl_sex(who, pic):
    ...
    show screen show_event("resources/events/" + pic, ys=1.0)
    with dissolve
...
label iulia1():
    ...
    carpenter "Lala... Oh, hello, [MC.name]-Boss? How are ya this morning?"
    ...
    "She takes a towel and wipes beads of sweat that are running between her big tits. Your jaw drops a little more."
...
label iulia2(): # Happens after completing 10 furniture (20-30-40)
    ...
    "Woman's voice" "Aaah! Keep yer dirty hands off me, ya creep!"

    "You hear a commotion in a nearby alley. You wouldn't normally pay attention to something like this in the mean streets of Zan, but her voice sounds familiar."

    show bg ambush1 at top with dissolve
    show carpenter at center with dissolve:
        ypos 1.1
    show guard at totheright with dissolve:
        zoom 0.9
        ypos 1.05
    show guard at totheleft as g2 with dissolve:
        zoom 0.9
        ypos 1.05

    guard "Woman! Master Holz has reported you for harassment and the practice of carpentry without a guild's membership. This is going to cost you."

    carpenter "Oh, gimme a break! You slimy fucks are just the guild's attack dogs!"

    carpenter "And harassment? Pah! I only elbowed that pig in the nose. He's lucky I didn't crush his wiener."

    guard "So you admit your guilt, then. Off to the city jail with you!"

    "The other guard lewdly ogles her."

    "Other guard" "You and me will have plenty of time to get more 'acquainted' in your cell... Heheheh..."

    play sound s_sigh

    carpenter "Now you've really done dun' it. You've made me fuckin' mad."

    "Other guard" "Oooh, check this out! Miss Big Titties is throwing a hissy fit!"

    guard "Cut it out, woman! You're coming with u-"

    play sound s_punch
    show carpenter attack2 at jumping

    with vpunch

    show guard at fly_off(x=0.8)
    show guard at left, jumping as g2 with move

    carpenter "JUST FUCK RIGHT OFF!"

    "Iulia slams her hammer into the ground, the shockwave sending both guards flying back."

    show carpenter with dissolve

    "Other guard" "KYAIII{size=-2}iii{size=-2}iiii{size=-2}iiiii{size=-2}iiiiii{size=-4}iiiiiiiii..."

    guard "This criminal is resisting arrest! Alert, alert!"

    "It looks like it's time for you to step in."

    you "*clear throat*"

    you "Hey, stand down, man. What cause do you have to arrest my employee?"

    guard "You stay out of this! If you know what's good for you." with vpunch

    guard "... Wait, are you her accomplice?"
    ...
    "Suddenly, the man seems to recognize you. He hurriedly changes his tone."

    guard "T-The Captain? O-Of course not sir! I- This is just a misunderstanding..."

    you "It is. Now grab your sorry excuse for a partner from the pavement, and go."

    guard "Y-Yes sir!"

    play sound s_dodge
    hide g2 with easeoutleft
    ...
    carpenter "It's just, ugh- I could never stand assholes like them, you know? Lordin' over like they didn't crawl out of their mother's snatch same as the rest of us!"

    "Her voice is still shaking with anger."

    carpenter "Err, sorry about the language. I can't hold me temper sometimes."

    you "Look, I get it. But can you keep it in check?"

    carpenter "I will, I will. It's just that I {i}hate{/i} when people try 'n' boss me around."

    carpenter "I-I mean except ya, of course, Boss! *blush*"

    scene black with fade

    "You both chat to relieve the tension as you head back to the brothel. In spite of her coarse manners, you can tell Iulia is grateful to you."

    return


label iulia3: # Happens after Iulia2 + completing 20 furniture (Ch2:20-Ch3:30-Ch4:40)

    if story_flags["iulia3"]: # Sanity check
        return
    ...
    "As you pass by Iulia's workshop, you hear the rhythmic thwack of her hammer. You decide to drop her a visit."

    show carpenter attack at center, jumping with dissolve

    carpenter "HAAA!" with vpunch

    you "Hi, Iulia. How is this coming up?"

    carpenter "Pretty good, Boss! Gotta finish this commission before long. This furniture ain't gonna carve itself."

    carpenter "Though I gotta admit, it's a mite warm in here. Hope ya don't mind me."

    "She straightens up, wiping sweat from her brow. Her usual skimpy underwear struggles to contain her voluptuous shapes."

    you "I'm not complaining..."

    carpenter "Thanks. *blush* Me old boss used to complain plenty. 'You shameless cow!' he'd yell - even though, let me tell you, I was never wearing this little around that guy."

    carpenter "Then he'd grab my arse when no one was lookin'. Pig."

    carpenter "You, though? You just let me work. Never tried to cop a feel, nothin'."

    "She stops her work for a moment, looking at you strangely."

    carpenter "You're never goin' to... Try something, are ya?"

    you "What do you mean?"

    carpenter "You know... Like... Touch my arse, or something."

    "Her tone is more curious than afraid."
    ...
    menu:
        ...
        "Fuck yeah!":
            ...
            you "With that juicy, bouncy ass of yours? Fuck yeah, daddy wants a piece of that! Come here."

            play sound s_surprise

            carpenter "EW! Get away from me!"

            carpenter "I knew it! All men are brutes!"

            "She is surprisingly sanguine about this. You retreat, apologizing, but she isn't hearing your words."

            play sound s_crash
            with vpunch
            "She slams the wagon's door in your face."

            scene black with fade

            you "(Well done, what a smooth talker... I don't think she'll want to open up to me after that.)" #!
        ...
        "I'm not sure":
            ...
            you "Well, I can't say the thought hasn't crossed my mind... But I can restrain myself."

            carpenter "Bah! I knew it!"

            "She seems more amused than shocked."

            carpenter "Men will be men, I suppose..."

            "She sets her hammer down, arms crossed under her chest, looking slightly away from you."

            you "I wouldn't want to make you uncomfortable."

        "No way":
            $ MC.good += 1

            you "No, I won't, Iulia. You do honest work for me. That means I respect your boundaries."

    carpenter "I know, I know. I'm so used to it, is all."

    carpenter "Men see me, they see these... *blush*"

    "She nods downwards, and you know what she means."

    carpenter "Not that I'm ashamed of 'em', or anything. I think I look fine."

    carpenter "Do {i}you{/i} think I look fine? *pointed*"

    "Sounds like a trick question."

    you "Well, uh... Of course, Iulia."

    carpenter "Hey, Boss, looky here, ya gave me a compliment! *blush*"

    carpenter "That means a lot coming from someone in your line of work. I always respect the opinion of a professional."

    "She hesitates for a second, then gives you a cheeky look. Her voice drops."

    play sound s_sigh

    carpenter "Tell you what, Boss... If {i}you{/i} ever brush against my arse, well..."

    carpenter "I won't be mad. Things happen, you know? *blush*"

    you "Hmmm... I will certainly consider it."

    carpenter "Just not when I'm swinging a chisel, okay?"

    "She winks at you, then turns back to her work."

    show carpenter attack at jumping
    ...
    "You leave Iulia's workshop. She gave you plenty of things to think about."

    return

label iulia4: # Happens after iulia3 + unlocking first tools (Ch2+)

    if story_flags["iulia4"]: # Sanity check
        return
    ...
    "Iulia is hard at work in her wagon this morning."

    show carpenter attack at center, jumping with dissolve

    carpenter "YAH!" with vpunch

    carpenter "Phew, nicely done..."

    "She hasn't seen you yet. You think back on what she said before..."

    hide carpenter with flashbackin
    carpenter sepia "Tell you what, Boss... If {i}you{/i} ever brush against my arse, well... I won't be mad."
    show carpenter attack with flashbackout

    you "(Maybe it's time to test that theory.)"

    you "Hi."

    "Coming from behind her, you pat her gently on the backside."
    ...
    "Iulia turns right around and swings her hammer right at your head."

    carpenter "DIE, YOU PIECE OF SHIT!!!" with vpunch

    "As it whistles through the air, you see your whole life flash before your eyes. For the most part, it's you poking your dick in various holes."

    "Right before she hits you, though, she stops."

    play sound s_sigh

    carpenter "Oh, uhm... B-Boss... It's you..."

    "She doesn't seem mad any longer. Instead, she blushes prettily."

    carpenter "Err, sorry boss. I thought you were one of 'em creepy guards."

    carpenter "They're always givin' me looks, or tryin' to cop a feel... So I have to whack them."

    you "Oh... That's why they're having so many sick leaves these days."

    carpenter "But not you, boss. Yer alright."

    you "Good to hear. What are you working on?"

    carpenter "My next project, and it's goin' real swell, thanks to these tools ya got me. They're Arios-sent."

    you "I'm glad you like them."

    carpenter "I'll be able to deliver much faster thanks to these."

    you "Perfect. I'll let you work, then."

    "Purposely, you give her another pat on the butt. Your fingers brush against her exposed skin."

    "She doesn't flinch, just giving you a strange smile. Then she turns back to her anvil."

    play sound s_clang

    show carpenter attack at jumping

    carpenter "IYAH!" with vpunch

    scene black with fade

    return

label iulia5: # Happens after Iulia4 + completing 30 furniture (Ch2:20-Ch3:30-Ch4:40)

    if story_flags["iulia5"]: # Sanity check
        return

    scene black with fade

    "Hearing some commotion in the brothel, you run into Iulia and Sill having an argument."

    show bg tavern at top with dissolve
    show carpenter at totheleft with dissolve

    carpenter "What are you on about, you whiny lil' brat?"

    show sill sad at totheright with dissolve

    sill "You broke TEN plates, TWENTY glasses, one table in half, and nearly dropped the candelier on top of the Earl of Nothingburg!" with vpunch

    carpenter "Oh yeah? Well... Well, I... I don't remember any of it."

    sill "But-"

    carpenter "And I especially don't remember that pompous arsehole with his yellow and lilac necktie, the mole on the upper left side of his stupid face, his foul breath and his stupid pompadour!"

    carpenter "And I don't remember spilling my drink on his breeches twice, either!"

    sill "Of course you don't!!! You were drunk as a skunk!" with vpunch

    carpenter "And you... You're dumb! Dumb as a cunt!" with vpunch

    sill "That doesn't even rhyme!!!" with vpunch

    you "Ahem, ladies? What seems to be the problem?"

    "Sill is red in the face with anger."

    sill "The problem, is that you odd job girl has been raiding the liquor cabinet again!"

    "Iulia crosses her arms."

    carpenter "Arh, gimme a break! I just needed to unwind after a long day of hard work!"

    carpenter "But you wouldn't know how to unwind, would you? What with the long-ass broomstick you always got stuck up your-"

    show sill sad at jumping

    sill "Enough! Rolling in the gutter is not 'unwinding'!"

    sill "And I'll have you know... I am perfectly able to relax! My behavior is not in question here-"

    carpenter "Oh, 'relax', eh? Only when you're riding the Boss's cock maybe!"

    carpenter "The whole brothel can hear you squeal! 'Master, Master, please fuck me harder-'" with vpunch

    carpenter "'Master, Master, please fuck me harder [emo_heart]...' *imitating Sill*"

    sill "I-I... *blush bright red*"
    ...
    menu:
        "Sill is right":
            ...
            you "You will help Sill with the repairs, and I hope you will mind your manners from now on."

            carpenter "But, Boss-"

            you "Pick up your tools, and get to work!"

            carpenter "*grumble* *grumble*"

            hide carpenter with dissolve

            show sill normal at center with move

            sill "Thank you, Master..."

            hide sill with dissolve

            "She kisses you on the cheek, then leaves off."

        "Iulia is right":
            $ NPC_sill.love -= 2

            you "Iulia is right, Sill. You should really learn to take it easy. Stop pestering Iulia with your complaints."

            sill "But-"

            carpenter "Ya heard the Boss, didn't ya? Get a move on! This place is a mess, don't you have a job to do?"

            sill "Grrrrr..."

            hide sill with dissolve

            show carpenter at center with move

            carpenter "That realy showed her... Thanks, Boss."

            "Unexpectedly, Iulia grabs your arm and pulls you closer. You can feel her generous chest pressing against you, but she doesn't seem to mind."

            carpenter "Ya were a right gentleman here, Boss. Thanks for sticking up for me like that."

            you "I can... Stick up... For you, any time."

            carpenter "It's good to know! *wink*"

            "She gives your arm a squeeze, burying it deeper between her mounds, and then lets you go."

            carpenter "See ya, Boss. Come have a drink with me sometime."

            hide carpenter with dissolve

        "Leave me out of this":
            $ NPC_sill.love -= 1
            you "I've heard enough. I'm done listening to the both of you bickering all day."

            you "Iulia, go back to your wagon. And you, Sill, fix this mess with the cleaners."

            carpenter "Boss-"

            sill "But-"

            you "Still here? Get a move on!" with vpunch

            hide sill
            hide carpenter
            with dissolve

            "The girls leave, unhappy."

            you "What is it with the help these days? Tsss..."

    scene black with fade

    return

label iulia6: # Happens after iulia5 + unlocking second tools. Tavern must be unlocked

    if story_flags["iulia6"]: # Sanity check
        return

    scene black with fade
    show bg outer gate at top with dissolve

    play sound s_crowd_laugh

    "Tonight, the party is in full swing."

    play sound s_cheer fadein 3.0
    show bg tavern at top with dissolve

    "It's one of these nights where everything feels great. The girls and the customers are having fun, they're behaving, no complaints to the management - yet."

    "You decide to enjoy your own hospitality and go grab a drink."

    stop sound fadeout 3.0

    "As you near the bar, you hear a familiar voice call out your name."

    play sound s_surprise

    carpenter "Booooss! Hey! Come over!"

    show carpenter with dissolve

    you "Oh, hi, Iulia!"

    "She sits in front of a large glass of red wine. Her face is flushed, and you can tell that she's already had a few."

    "She pats the stool next to her, with a wide, tipsy grin on her face."

    carpenter "Sit yerself down, Boss!"

    you "You seem to be enjoying yourself."

    carpenter "Pfff... Truth is, I'm gettin' bored here, all by meself. I need the company."

    "You sit next to her, keeping close to be able to hear her over the noise."

    carpenter "It's impressive, this place you built. And ya did it all on yer own..."
    ...
    menu:
        "You bet I did":
            ...
            you "The girls have it easy, all they have to do is to lay down on their back. And still they complain endlessly..."

            carpenter "Don't tell me."

            you "I have to do everything around here! Everything!" with vpunch

            you "Like, do you know I have to carry all these bags of money upstairs every night? I could break my back!"

            carpenter "Whoah. Okay. Sounds tiring."

        "It's thanks to the girls":
            $ MC.evil -= 1

            you "Thanks, but I couldn't do it without my girls, of course."

            carpenter "I s'pose. But you have to give me a lil' credit too, eh?"

            you "I just did. You {i}are{/i} one of my girls. In your own way."

            carpenter "Oh, I, erm... Thanks. *blush*"

            "She seems genuinely touched by your remark about belonging to the group. She's not as much of a lone wolf as she seems."

        "It's all thanks to Sill":
            $ MC.good += 1
            $ NPC_sill.love += 1

            you "Actually, Sill helps me so much. I couldn't do it without her."

            carpenter "Sill? Again with that lil' brat?"

            carpenter "Ya don't need that mink Boss! You be doin' perfectly fine without her, that's for sh-sure! *hiccup*"

            you "You know it's not true. Sill works her ass off to help me."

            carpenter "Oh, I get it. She works her ass off in many ways, don't she? *annoyed*"

            "Her mood darkens and she falls silent. You try to break the awkwardness."

    you "Come on. Let's order another round."

    carpenter "Right, Boss! Here's an idea! *hiccup*"

    "A waitress brings you another bottle."

    carpenter "How's about a toast?"

    you "A toast? To what?"

    carpenter "To you, of course! And yer girls. To the Boss, yer the Man!"

    "*cling*"

    "She raises her glass, sloshing some wine around."

    carpenter "C'mon, everyone! Let's give a toast to the Boss of this fine eshtablish... establiss.. essesstabilish..."

    carpenter "This fine whorehouse!" with vpunch

    play sound s_cheer fadein 3.0

    "Around you, the crowd starts chanting and cheering."
    ...
    carpenter "And so I told him, you can take that table peg, and stick it up your... *hiccup*"

    "Iulia is now fully in her cups, telling naughty anecdotes in vivid detail to a bunch of equally drunk patrons."

    "Her stories are good enough that no customer has tried to lay a hand on her yet, even though her agitation is threatenning to make a boob pop out of her ample cleavage."

    carpenter "And he did!!!! BWAHAHAHA!!! *hic*" with vpunch

    "You are not much better yourself, having drunk almost an entire bottle of Dom Pericoloso."

    carpenter "Oh, man... I'm feelin' a lil' light-headed right now..."

    "You're not really sure when that happened, but somehow, Iulia ended up on your lap, with your hand clinging to her lower back. She seems completely oblivious to it, even though you give her a drunken, appreciative squeeze from time to time."

    "As her dress inches higher, you steal a glimpse at her panties. Even though you've seen her in her underwear many times, old habits die hard."

    "She leans tipsily towards you, and her hot breath tickles your ear."

    carpenter "Boss? You alright? You're awful quiet all of a sudden..."

    "She shifts sideways, her arms now around your neck and her chest pressing against you. Your hand caresses her thigh absentmindedly, feeling her warm skin."

    carpenter "Ya know, I was thinkin'... Maybe I should thank you proper?"

    you "Thank me? For what?"

    carpenter "Well, you know. You got me a job, a roof over me head..."

    "She leans in, whispering in tour ear once again."

    carpenter "You've been good to me, Boss."

    "She bites your earlobe, almost too sharply, but not quite."

    carpenter "Now... I wanna be good to you."

    scene black with fade

    "You move the party upstairs."

    play sound s_dress
    
    "You are both out of your clothes as soon as the door closes, in a flurry of fabric and laughter."

    call iulia_sex1(first=True)

    "You lie by each other's side, your head spinning from the alcohol and exertion."

    scene black with fade

    you "Listen, Iulia. Maybe we should-"

    carpenter "*snore*"

    you "...maybe we should talk about this some other time."

    carpenter "*heavy snore*"

    "When you wake up the next morning, Iulia is already gone off to work."

    "When you meet her again in [brothel.name], she acts completely normal, as if nothing had happened."

    "But as you turn around to leave, you can feel her eyes on you."

    return


label iulia7: # Happens after iulia6 + unlocking third tools.

    if story_flags["iulia7"]: # Sanity check
        return
    ...
    "You decide to check on Iulia this morning, to see how she's handling her new tools."

    play sound s_clang
    show carpenter attack at center, jumping with dissolve

    carpenter "AYAH!" with vpunch

    "Iulia is hard at work in her underwear as usual, her skin glistenning with sweat."

    you "Impressive work."

    carpenter "Oh, hi, Boss! These new tools are fantastic!"

    you "Hi, Iulia..."

    "You give her skimpy underwear an appreciative look."

    "Coming up from behind, you grab her buttcheek, fondling the flesh left exposed by her thong."

    carpenter "C'mon, Boss... I'm all sweaty... [emo_heart]"

    "She wiggles her butt a little, without any real intention to evade your touch. Instead, she brushes against the bulge in your pants."

    play sound s_sigh
    carpenter "Hmmm... Looks like someone's happy to see me."

    you "Listen, Iulia... Do you want to talk about what happened the last time?"

    carpenter "Talk? Nah, Boss. I don't wanna talk. What's done is done, besides... T'was fun, wasn't it?"

    you "Okay."

    carpenter "Instead... I could show you something."

    carpenter "I bought something for you. As a token of my appreciation for giving me these masterful tools..."

    hide carpenter with dissolve
    play sound s_dress

    "She asks you to turn around, and you hear the ruffle of cloth against skin."

    show carpenter lingerie at totheright with dissolve

    carpenter "Wha... Whadaya think, Boss?"

    "Iulia has changed into a brand new set of sexy lingerie. You can barely recognise her in such delicate clothing."

    you "Whoah!"

    carpenter "Ya don't like it? *blush*"

    "She turns around. The black lace highlights her curves, contrasting with her smooth light skin."

    you "Actually, it's lovely."

    carpenter "Y-You think? I'm glad, Boss... *blush*"

    "She looks flustered and vulnerable. You step closer."

    you "Thank you for the attention. You look beautiful in these."

    "Iulia leans in and kisses you. Sober this time, she's much more awkward than the last time."

    play sound s_sigh

    "Your hands find your way down from her hips, and she sighs."

    carpenter "Boss... How would you like to see me... Out of these?"

    "She takes your hand, and pulls you towards her bed."
    ...
    "Both of you collapse together, breathing hard."

    you "Hmmm... That was good..."

    "She nods against your chest, holding you tight."

    "You stay like this a while before she speaks again."

    carpenter "Look, Boss. I don't want things to change between us."

    carpenter "I just wanted you to know, that... That I appreciate you."

    "She looks straight at you, and you give her a deep kiss."

    you "I accept this... Token of your appreciation."

    carpenter "Aye, Boss. *giggle*"

    carpenter "There may be more comin' yer way then. *wink*"

    scene black with fade

    "After cuddling on Iulia's bed for a while, you reluctantly tear yourself away to resume your other business."

    return


label iulia_H: # Happens after iulia7 + building 40 furniture.
    ...
    if d == 1:
        ...
        "You are busy doing your morning inspection, when someone pokes your arse from behind."
        ...
        carpenter "Haha, Boss, can't a girl have a lil' fun?"

        you "Oh, it's you?"

        "Iulia seems cheerful this morning. You decide to forgive her transgression."

        you "What's up, Iulia?"

        carpenter "Well... I was looking for you."

        you "Were you?"

        carpenter "Yup. You see... *blush*"

        carpenter "I woke up kinda randy this morning, and I was wondering if you and me, we could... You know."
        ...
        "This morning, you decided to pay a visit to Iulia as she works."
        
        play sound s_clang
        show carpenter attack at center, jumping with dissolve

        carpenter "Ha! And done!"
             
        you "Hey, Iulia. How is it going?"

        carpenter "Fine boss, I had to finish to shape this part. Phew, I really broke up a sweat."

        you "You should take a break."

        carpenter "I should, shouldn't I?"

        "She looks at you with a glimmer in her eye."

        carpenter "Boss, why don't you help me out of these dirty clothes?"

        carpenter "I have an idea how we could unwind... *blush*"
        ...
        "You wake up with a strange feeling. Someone is there in the room with you."

        show carpenter lingerie with dissolve
        ...
        carpenter "I couldn't sleep, so..."

        you "You couldn't sleep? Do you always sleep in sexy lingerie?"
        
        carpenter "No... I put these on for you..."
    ...
    carpenter "You know what I want from you. [emo_heart]"
    ...
    menu:
        ...
        "Give it a pass":
            you "I'm sorry, Iulia. I'm too busy right now. Maybe some other time."

            carpenter "Oh. I see. Too bad then, Boss."
...
label iulia_sex1(first=False):

    if first:
        "Iulia's hands are on you immediately, clumsy with drink but eager. You grab her back, and enjoy the fullness of her juicy boobs."

    else:
        "Iulia's eager hands are on you immediately. You grab her back, and enjoy the fullness of her juicy boobs."

    "She shoves you on the bed, and she's onto you before you have a chance to object."

    show bg iulia_sex1 at top with dissolve
    ...
    "She's straddling you, her wet pussy already rubbing against your hard cock."

    if first:
        carpenter "I waited long enough for this, ya know?"
    else:
        carpenter "Oh, yes, gimme that big boy..."

    if first:
        you "Why didn't you come and find me?"

        carpenter "C'mon, Boss... I'm not that kind of gal..."

        you "Well... It's not obvious from the way your pussy clings to my dick."

        play sound s_mmh
        with vpunch

        carpenter "Hmmm... What can I say... I need sex, a'right."

        carpenter "But not just with anyone. I need to have some... You know."

        you "Alcohol?"

        carpenter "No, you dumb fuck! Aaaah..." with vpunch

        carpenter "Fee- Feelin's. They're called feelin's."

        you "Hmmm... I'm flattered..."

        "You hesitate, wondering if she wants you to reciprocate, but instead she slowly lowers herself on your cock until she takes its full length, enjoying the moment."
    ...
    carpenter "Shut up, Boss. Let's fuck!"

    if first:
        "In the throes of passion, you are both too drunk and horny to continue the conversation."

    "She smiles as you start moving, guiding your hand to her boobs."

    play sound s_moans_quiet
    with vpunch

    carpenter "Ooh, aah, aaaah..." with vpunch

    "You pick up the pace, making her bounce off your cock, hitting the back of her cunt at full strength with every thrust."

    with vpunch

    carpenter "Ooh, you're really ramming it in... Aaaaah..."

    "She is built for this, and begs you for more."

    with vpunch

    carpenter "Harder! Harder!!!"

    "Her pussy clenches around your cock. You both throw caution to the wind and start banging like brutes."

    carpenter "Ooh, Boss! I feel... I feel tingly..." with vpunch

    "Her moans grow louder, her moves more urgent."

    you "Iulia... I'm going to cum..."
    ...
    carpenter "Who cares! Give it to me!"

    "Unable to stop yourself, you fuck her hard one last time, before releasing it all inside her."

    show bg iulia_sex2 at top with flash
    ...
    "Her body shakes as the wave crashes through her. Your cock pops out, raining cum all over her bubbly ass."

    with flash

    carpenter "Shit, Boss... That was... Somethin' else."

    "She collapses onto the bed, panting heavily, her skin covered with sweat."

    carpenter "Gonna feel that tomorrow..."
...
label iulia_sex2():
    ...
    "Iulia moans as you kiss her again. In spite of her bravado, she feels shy and exposed."
    ...
    play sound s_dress
    show bg iulia_sex3 at top with dissolve

    "With years of practice, your fingers unfasten the clasps of her lingerie, exposing her bare skin."

    "You lay her softly on the bed."

    carpenter "Boss... *anxious*"

    "She grabs your hands, guiding them towards her large, supple breasts."

    play sound s_ahaa

    "She gasps softly as your hands cover her mounds."

    carpenter "I... I havent done this in a while... B-Be gentle."

    "Even as she says that, she spreads her legs, welcoming you."

    "You move between her thighs, your dick rubbing against her clit."

    play sound s_aaah

    carpenter "Aaaah..."

    "She shudders at your contact, her wetness spreading."

    carpenter "Ahh... Boss..."

    "Lubricating your cock with her juices, you place it at the entrance of her pussy, slowly pushing inside."

    play sound s_moans

    carpenter "Haaa!" with vpunch

    "She takes a sharp breath, her body tensing around you."

    carpenter "B-Boss..."

    "You start moving at a leisurely pace. Little by little, she relaxes."

    you "You can call me [MC.name], you know."

    carpenter "Y-Yes... Boss..."

    "She grabs your hands, holding you closer as you play with her beautiful tits."

    "Her hips move in sync with you, her erotic moans filling the room."

    you "Is it okay if I go faster?"

    carpenter "Anything is good... Do as you like..."

    play sound s_aaah
    carpenter "Aaah!!" with vpunch

    "You start fucking her faster. Her breathing quickens, her chest rising and falling under your touch."

    play sound s_mmh

    carpenter "Boss, I... I'm getting close..."

    carpenter "Aaaah!" with vpunch

    you "So am I."

    carpenter "Can you, hmmm... Can you stay inside? Today is safe."

    "She arches her back, pushing you deeper inside her."

    play sound s_ahaa

    carpenter "Ahaa..." with vpunch

    "You thrust deeper, picking up the pace."

    play sound s_scream_loud

    carpenter "Ahh!!!" with vpunch

    with flash

    "She cries out, her body trembling, her pussy walls clenching around your cock."

    show bg iulia_sex4 at top with doubleflash

    carpenter "Aaaaah! [MC.name]! B-Boss!!!"

    with flash

    play sound s_orgasm

    "Her orgasm crashes through her. A few more strokes and you follow, spilling deep inside her."
...
label iulia_sex3():
    ...
    "Iulia swiftly removes your clothes, and pushes you down on the bed."

    "She takes her time removing her bra, exposing her naked breasts to your expert eye."

    carpenter "I have you right where I wanted, Boss..."

    show bg iulia_sex5 at top with dissolve

    "She straddles you. Even as she is giving you a show of confidence, you can feel her hands tremble as she rests them on your chest."

    you "Are you nervous?"

    carpenter "M-Maybe."

    you "I know a trick to loosen up."
    ...
    "Licking your fingers, you shove aside Iulia's panties and start playing with her butthole."

    play sound s_ahaa

    carpenter "B-Boss!!! What are you... Ahaaa..." with vpunch

    "She was so surprised that she barely noticed your cock is already pressing against her slit."

    you "I said it would help you loosen up."

    "You continue circling the rim, building pressure gently. Iulia's breathing turns ragged."

    play sound s_aaah

    carpenter "A-ah... S-slow down, Boss... I'm not... Aaaah!" with vpunch

    "Unconsciously, she lowers herself onto you, and her tight pussy swallows your cock as she moans."

    play sound s_moans_short

    carpenter "Oooh, aaah, aaaah!!!" with vpunch

    "Her senses are overwhelmed. You take advantage of her predicament, pushing a finger inside her tight asshole."

    carpenter "Ngh... Boss... that's... Ngggh-" with vpunch

    "You both start moving, hips rolling. You feel her tighten around you. Your finger keeps moving, matching the rhythm."

    play sound s_scream_loud

    carpenter "I-I can't... It's too... Aaah..." with vpunch

    "She interrupts herself, moaning. Both of her holes clench around you."

    carpenter "Hmmm, aaah..."

    "Mercilessly, you push a second finger inside her asshole, stretching it further."

    play sound s_orgasm_fast

    carpenter "B-Boss, I... I'm gonna-" with vpunch

    with flash

    "Her words stop right in her mouth as she cums unexpectedly, her whole body shaking."

    "You keep the rhythm steady, fucking her to the hilt with every thrust. You feel your own release coming."

    show bg iulia_sex6 at top with flash

    carpenter "Aaaaah!!! I-I'm c-cumming again...!" with vpunch

    with doubleflash

    "You spill your seed inside her as she cries out, her body rocked by a second orgasm."

    carpenter "Aw, you jerk... You found my sensitive spot... *blush*"

    "Even as she scolds you, she smiles."

    carpenter "Yer a real piece of work, you know that?"
...
# xcowg hnd on bb bed, 1x + 1cin + c on ass
# miss on bed, hnds on bbs, rose petals and black bra, 1enter + 1cin
# cowg on bed, finger on assh, 1x + 1cin/org, hnd on bb
...
label bast_informant():
    ...
    show expression "resources/events/" + security_pics["hood"][0] at top:
        zoom 1.025
...
label ninja_guest2: # Magician event
    ...
    "As you run through an abandoned house in an attempt to corner the Kunoichi, the floor gives way, sending you crashing down into a cellar."
...
label ninja_guest3: # Scientist event
    ...
    girl_scientist "Interesting... *grumble* The subject has developed a natural immunity to mojo exposure..."
...
label chaos_update():
    ...
    if not story_flags["first chaos refill"]:
        ...
        if dice(10) == 10:
            chaos "And in the morning it's girls! 'Cause in the evening it's girls! Two at a time I want girls!"
            
            chaos "Girls! Girls! Girls! Girls! Girls! Girls! Girls! Girls!"

            you "Okay, okay, damn it! I get it!"
...
label chaos_swap(it):
    ...
    call receive_item(it, equip=equip, use_article=False) from _call_receive_item_24
