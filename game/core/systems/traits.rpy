...
label init_traits():
    ...
    python:
        ...
        pos_traits = [
                        ...
                        Trait("Heavy-sleeper", "be a", eff1 = Effect("change", "energy when resting", 12), opposite = ["Insomniac"]),
        ...
        neg_traits = [
                        ...
                        Trait("Insomniac", "be", eff1 = Effect("change", "energy when resting", -12), opposite = ["Heavy-sleeper"]),
