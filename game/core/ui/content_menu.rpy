...
default hm_settings = {
    "content" : [
        ...
        "UI" : [
            ...
            HMSetting("hover_for_preview_girls", ["Do not preview girls", "Preview girls"], ttips=["You will not see a girl's profile when hovering over her button.", "You will see a girl's profile when hovering over her button."]),
            HMSetting("hover_for_preview_postings", ["Do not preview quests/classes", "Preview quests/classes"], ttips=["You will not see a class or quest's profile when hovering over its button.", "You will see a class or quest's profile when hovering over its button."]),
