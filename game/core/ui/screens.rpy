        ...
        if girl.profile != None:
            ...
            if (context == "girls" and not girls_firstvisit) or context == "free" or context == "farm":
                ...
                vbox xalign 0.0 yalign 0.0 spacing 6:
                    ...
                    #         add "resources/ui/calendar.webp" zoom 0.5 idle_alpha 0.66 hover_alpha 1.0
                    ...
                    if MC.get_effect("special", "notebook"):
                        ...
                        button background None xsize xres(80) ysize yres(80) xmargin 10 xpadding 0 action Show("notebook") tooltip "Open %s's entry in your magical notebook (shortcut: {u}n{/u})" % girl.fullname:
                            at alpha_transform
                            add "resources/items/misc/magic notebook.webp" fit "contain" # idle_alpha 0.66 hover_alpha 1.0 
        ...
        vbox:
            ...
            hbox:
                ...
                if game.chapter >= 4:
                    ...
                    add ProportionalScale("resources/ui/" + license_dict[2][1], *res_tb(50))

                else:

                    add ProportionalScale("resources/ui/" + license_dict[0][1], *res_tb(50))
        ...
        vbox:
            ...
            hbox:
                ...
                if game.chapter >= 6:
                    ...
                    add ProportionalScale("resources/ui/" + license_dict[3][1], *res_tb(50))
...
screen contract_tab(contract, x=320, active=False):
    ...
    frame xalign 0.5 yalign 0.5 xsize xres(x) ysize yres(600) xpadding 10 ypadding 10:
        ...
        viewport:
            ...
            vbox spacing 3:
                text "The " + contract.location.name drop_shadow (1, 1) font "resources/fonts/MATURASC.ttf" color c_brown
