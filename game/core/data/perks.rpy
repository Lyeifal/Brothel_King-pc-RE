...
init -1 python:
    ...
    perk_dict = {
                    ...
                    "Hardworking" : Perk(name="Hardworking", type="level", perk_level=1, archetype="The Maid", effects=[Effect("boost", "upkeep", -0.15), Effect("boost", "waitress jp gains", 0.1)], pic = "maid1_2.webp"), # Lowered JP bonus from 0.15 to 0.1
                    ...
                    "Bimbo" : Perk(name="Bimbo", type="level", perk_level=1, archetype="The Player", effects=[Effect("boost", "reputation gains", 0.15), Effect("boost", "dancer jp gains", 0.1)], pic = "player1_2.webp"), # Lowered JP bonus from 0.15 to 0.1
                    ...
                    "Overachiever" : Perk(name="Overachiever", type="level", perk_level=1, archetype="The Model", effects=[Effect("change", "all skill max", 10), Effect("boost", "masseuse jp gains", 0.1)], pic = "model1_2.webp"), # Lowered JP bonus from 0.15 to 0.1
                    ...
                    "Refined taste" : Perk(name="Refined taste", type="level", perk_level=1, archetype="The Courtesan", effects=[Effect("boost", "bisexual chance", 0.5), Effect("boost", "geisha jp gains", 0.1)], pic = "courtesan1_2.webp"), # Lowered JP bonus from 0.15 to 0.1
                    ...
                    "Bedroom Eyes" : Perk(name="Bedroom Eyes", type="level", perk_level=1, archetype="The Slut", effects=[Effect("boost", "service jp bonus", 0.1), Effect("boost", "sex jp bonus", 0.1), Effect("boost", "anal jp bonus", 0.1), Effect("boost", "fetish jp bonus", 0.1)], pic = "slut1_2.webp"), # Lowered from 0.25 to 0.1
                    ...
                    "Confession" : Perk(name="Confession", type="level", perk_level=1, archetype="The Bride", effects=[Effect("spillover", "xp", 0.1), Effect("spillover", "jp", 0.1)], pic = "bride1_2.webp"), # Lowered from 0.2 to 0.1
    ...
    ## REGISTER PERKS TO REGISTRY (Phase 6) ##
    for _perk_name, _perk_obj in perk_dict.items():
        perk_registry.register_perk(_perk_obj, category=_perk_obj.archetype)
    del _perk_name, _perk_obj
    ...
    # Register special perks too
    perk_registry.register_perk(naked_perk, category="special")
    perk_registry.register_perk(pony_perk, category="special")
    perk_registry.register_perk(bis_perk, category="special")
    perk_registry.register_perk(group_perk, category="special")
    perk_registry.register_perk(orgy_perk, category="special")
