...
label init_postings():
    python:
        ...
        quest_templates = [
                        ...
                        Quest("quest", name = __('Private dance'), main_stat = 'Body', second_stat = 'Constitution', other_stats = ("Beauty", "Charm", "Refinement"), tags = 'dance', description = __("Looking for a private, intimate dance...."), sound = s_sigh),
        ...
        class_templates = [
                            Quest("class", name = __('Modeling'), main_stat = 'Beauty', second_stat = 'Libido', other_stats = ("Body", "Charm", "Refinement"), jp_type = all_jobs, tags = 'model', description = "Lea__("n the secrets to looking fabulous and have perfect hair at all times! Who wants to look natural anyway?"), sound = s_sigh),
                            
                            Quest("class", name = __('Dancing'), main_stat = 'Body', second_stat = 'Constitution', other_stats = ("Beauty", "Charm", "Refinement"), jp_type = ["dancer"], tags = 'dance', description = "Zom__("a! Bodyfighting! Aqua reggeaton!\nHurry before we make up even more silly names!"), sound = s_sigh),
                            
                            Quest("class", name = __('Waitress'), main_stat = 'Charm', second_stat = 'Obedience', other_stats = ("Beauty", "Body", "Refinement"), jp_type = ["waitress"], tags = 'waitress', description = "Lea__("n the basics of working tables... You'll never spill a glass on a customer's crotch again, unless you want to!"), sound = s_sigh),
                            
                            Quest("class", name = __('Geisha'), main_stat = 'Refinement', second_stat = 'Sensitivity', other_stats = ("Beauty", "Body", "Charm"), jp_type = ["geisha"], tags = 'geisha', description = "Mas__("er all Zanic traditional arts, including the exact science of tea ceremony trigonometry. Don't look like an ass because your tea cup is off 5 degrees to the left!"), sound = s_sigh),
                            
                            Quest("class", name = __('Massage'), main_stat = 'Libido', second_stat = 'Sensitivity', other_stats = ("Beauty", "Body", "Refinement"), jp_type = ["masseuse"], tags = 'masseuse', description = "Spe__("d a relaxing few days at the spa with us. It will be awesome! As for the teaching... Wait, what teaching?"), sound = s_aaha),
                            
                            Quest("class", name = __('Swimming'), main_stat = 'Constitution', second_stat = 'Libido', other_stats = ("Body", "Charm", "Refinement"), jp_type = ["masseuse"], tags = 'swim', description = "The__("sun shining on exposed bodies... Water running along voluptuous curves... Tanning oil on glistening skin... And swimming, of course. Erm."), sound = s_aaha),
                            
                            Quest("class", name = __('Singing'), main_stat = 'Sensitivity', second_stat = 'Obedience', other_stats = ("Beauty", "Charm", "Refinement"), jp_type = ["dancer", "geisha"], tags = 'sing', description = "'Si__("g properly dammit, or I'll rip off your head and shove manure down your neck!'. How bad can a singing class be? Oh, you'll see..."), sound = s_aaha),
                            
                            Quest("class", name = __('Maid'), main_stat = 'Obedience', second_stat = 'Constitution', other_stats = ("Beauty", "Body", "Charm"), jp_type = ["waitress"], tags = 'maid', description = "'If__("you want to clean up properly, you have to bend forward a lot more! More... More... Hmm, that's better.'"), sound = s_aaha),
                            
                            Quest("class", name = __('XXX{#1}'), main_stat = 'Service', second_stat = 'Sex', other_stats = ("Libido", "Constitution", "Obedience", "Sensitivity"), jp_type = ["service", "sex"], tags = 'XXX', description = "Lea__("n to pleasure a man... Or a woman, if you're so inclined. Why not learn both?{#1}"), sound = s_aah),
                            
                            Quest("class", name = __('XXX'), main_stat = 'Sex', second_stat = 'Anal', other_stats = ("Libido", "Constitution", "Obedience", "Sensitivity"), jp_type = ["anal", "sex"], tags = 'XXX', description = "Lea__("n to pleasure a man... Or a woman, if you're so inclined. Why not learn both?"), sound = s_aah),
                            
                            Quest("class", name = __('Hardcore{#1}'), main_stat = 'Anal', second_stat = 'Fetish', other_stats = ("Libido", "Constitution", "Obedience", "Sensitivity"), jp_type = ["anal", "fetish"], tags = 'hardcore', description = "We'__("e got more tools than a hardware store, more beasts than the palace zoo... And by the time we're finished, they're all gonna fit inside of her!{#1}"), sound = s_scream),
                            
                            Quest("class", name = __('Hardcore'), main_stat = 'Fetish', second_stat = 'Service', other_stats = ("Libido", "Constitution", "Obedience", "Sensitivity"), jp_type = ["service", "fetish"], tags = 'hardcore', description = "We'__("e got more tools than a hardware store, more beasts than the palace zoo... And by the time we're finished, they're all gonna fit inside of her!"), sound = s_scream),
                            ]
