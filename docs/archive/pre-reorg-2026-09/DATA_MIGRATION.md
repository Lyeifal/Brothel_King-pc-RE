# BK Evolution — 数据驱动化迁移计划

> 本文档追踪 `game/core/` 目录下所有硬编码数据向 JSON 的迁移进度。
> 创建日期：2026-06-08
> 当前阶段：Phase 7.5（硬编码全面排查）
...
| 14 | 图片/音频列表 | ⭐ | `init/settings.rpy` | `data/assets/images.json` + `data/assets/audio.json` | ⏳ 待开始 | ⏳ 待开始 | — |
